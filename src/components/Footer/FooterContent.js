...
export const footerData = {
    ...
    column2: {
      ...
      subtitles: 
      [
        'Atraksione Turistike', 'Turizmi Outdoor', 'Struktura akomoduese', 
        'Produkte te zones', 'Fshatrat'
    ],
    },
    column3: {
      title: 'Linke te nevojshme',
      subtitles: ['Bashkia Kelcyre', 'Facebook', 'Instagram', 'Twiter'],
    },
    column4: {
      title: 'Adresa',
      subtitles: [
        'Bashkia Kelcyre', 'Sheshi Musa Fratari zip code 6402', 'Cel: +355 68 917 7771',
        'kelcyraraftingteam@gmail.com', 'Gryka e kelcyres(Prane fabrikes se ujit Trebeshina)'
    ],
    },
  };